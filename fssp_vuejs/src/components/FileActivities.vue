...
export default {
  data() {
    return {
      isLoading: ref(true),
      items: ref([
        { username: 'USERNAME', fullname: "FULL NAME" , operation: 'OPERATION', file: 'FILE NAME', date: '1970-01-01 00:00:00'},
        ]),
      search: '',
    };
  },
  ...
  async mounted() {
        await axios.get(DJANGO_API_URL + 'get_user_eventlogs_files', 
