    ...
    <div class="container ml-10">
        <v-layout wrap fluid style="overflow-y: auto;" class="flex-column">
            <v-flex xs12 sm6 md6 lg1 style="height: 350px;" v-for="secret in secrets" :key="secret.Title">
                <v-card style="height: 280px;width: 800px" variant="outlined" flat color="#aac7e8" class="yellow-card d-flex ma-7 pa-8 text-center d-block rounded-lg elevation-15 mx-auto">
